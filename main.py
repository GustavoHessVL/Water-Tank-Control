...
ser = serial.Serial('COM9', 115200, 7, 'O', 1, timeout=1) 
...
# Adicione uma nova função para exibir dados no canto superior direito
        ...
        if event.type == pygame.QUIT:
            ...
            for i, pos in enumerate(button_positions):
                if (
                    ...
                    binary_data = button_to_binary.get(i, '0000000')
                    print(i, binary_data, binary_data.encode())
